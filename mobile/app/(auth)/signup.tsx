...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      console.error(err);
      Alert.alert('Signup Failed', err.response?.data?.message || 'Check your details and try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <ThemedView style={styles.container}>
        <ThemedView style={styles.header}>
          ...
          <ThemedText style={styles.subtitle}>Start your journey to financial freedom.</ThemedText>
        </ThemedView>
